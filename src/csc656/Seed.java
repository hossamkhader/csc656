 ...
 * The seed generator will supply the class with a character to be used
 * to represent a hole in the seed.
 *
 * A seed object is a representation of the 'z' value presented in the paper.
 */
public class Seed {
    ...
    /**
     * @return number of holes in the seed.
     */
    ...
    /**
     * Compute the number of holes in the seed by counting the number
     * of hole characters found while traversing the seed String.
     */
    ...
    /**
     * @return char used to represent a hole in the seed.
     */
